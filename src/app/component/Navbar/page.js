...
const Navbar = () => {
  ...
  return (
    <div className='bg-[#023020]'>



      <nav className="flex   justify-between items-center max-container padding-container relative z-10  max-w-[1200px] m-auto ">
       ...
       <Image
        ...
        {/* Mobile Menu */}
        <div
          className={`fixed top-0 right-0 w-full h-screen bg-white m-auto pb-5 items-center justify-center  lg:hidden transform transition-transform duration-500 ${isMobileMenuOpen ? "translate-x-0" : "translate-x-full"
            }`}
        >
          ...
          <div className='px-12'> <div className="relative  my-8  items-center w-full">
              <input
                type="search"
                id="search"
                className="block w-full p-3 outline-none ps-4 text-sm text-gray-900 border border-gray-300 rounded-md dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-300"
